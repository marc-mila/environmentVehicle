...
c.execute(sql)
sql = "DELETE FROM traffic_lights_ip"
c.execute(sql)
...
c.execute(sql)
sql = "DELETE FROM streetlights"
c.execute(sql)
sql = "DELETE FROM streetlights_ip"
c.execute(sql)
...
try:
  sql = '''INSERT INTO traffic_lights_ip (name, ip) VALUES (?, ?)'''
  c.executemany(sql, traffic_light_mngmt)
except sqlite3.IntegrityError as e:
  print('sqlite error: ', e.args[0]) # column name is not unique
try:
...
try:
  ...
  print('sqlite error: ', e.args[0]) # column name is not unique
try:
  sql = '''INSERT INTO streetlights_ip (name, value) VALUES (?, ?)'''
  c.executemany(sql, streetlights_mngmt)
except sqlite3.IntegrityError as e:
  print('sqlite error: ', e.args[0]) # column name is not unique
